...
| 1 | Browser Extension | `01-extension.md` | IN PROGRESS (prototype baseline built) | P0 |
| 2 | Anchor Node | `02-anchor-node.md` | IN PROGRESS (REST/WS MVP live) | P0 |
| 3 | PWA Companion | `03-pwa.md` | TODO | P1 |
| 4 | Shared Package | `04-shared-package.md` | IN PROGRESS (storage/membrane + API/message contracts added) | P0 |
| 5 | Smart Contracts | `05-contracts.md` | TODO | P1 |
| 6 | Org-OS Integration | `06-org-os-integration.md` | TODO | P2 |
| 7 | Skills System | `07-skills-system.md` | IN PROGRESS (impact-reporting baseline path) | P1 |
| 8 | Cross-Cutting | `08-cross-cutting.md` | IN PROGRESS (.env example + build checks) | P0 |
