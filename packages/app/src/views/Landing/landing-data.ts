...
> = {
  tabs: [
    { x: '5vw', y: '-6vh', rotate: -5, scale: 0.98, opacity: 1 },
    { x: '12vw', y: '-8vh', rotate: 4, scale: 0.9, opacity: 1 },
    { x: '19vw', y: '-9vh', rotate: -3, scale: 0.72, opacity: 0.94 },
    { x: '24vw', y: '-8vh', rotate: 2, scale: 0.42, opacity: 0.7 },
    { x: '26vw', y: '-6vh', rotate: 0, scale: 0.34, opacity: 0.5 },
    { x: '27vw', y: '-3vh', rotate: 0, scale: 0.06, opacity: 0 },
  ],
  notes: [
    { x: '3vw', y: '-4vh', rotate: 5, scale: 0.97, opacity: 1 },
    { x: '8vw', y: '-6vh', rotate: -4, scale: 0.88, opacity: 1 },
    { x: '13vw', y: '-8vh', rotate: 3, scale: 0.68, opacity: 0.92 },
    { x: '17vw', y: '-7vh', rotate: -2, scale: 0.4, opacity: 0.66 },
    { x: '18.5vw', y: '-5vh', rotate: 0, scale: 0.32, opacity: 0.44 },
    { x: '19vw', y: '-2vh', rotate: 0, scale: 0.06, opacity: 0 },
  ],
  ideas: [
    { x: '-3vw', y: '-4vh', rotate: -5, scale: 0.97, opacity: 1 },
    { x: '-8vw', y: '-6vh', rotate: 4, scale: 0.88, opacity: 1 },
  ...
  links: [
    { x: '2vw', y: '-5vh', rotate: -4, scale: 0.95, opacity: 1 },
    { x: '7vw', y: '-7vh', rotate: 3, scale: 0.86, opacity: 1 },
    { x: '12vw', y: '-8vh', rotate: -2, scale: 0.64, opacity: 0.9 },
    { x: '16vw', y: '-6vh', rotate: 1, scale: 0.36, opacity: 0.62 },
    { x: '17.5vw', y: '-4vh', rotate: 0, scale: 0.28, opacity: 0.38 },
    { x: '18vw', y: '-1vh', rotate: 0, scale: 0.05, opacity: 0 },
  ],
  drafts: [
    { x: '2vw', y: '4vh', rotate: 3, scale: 0.93, opacity: 1 },
    { x: '5vw', y: '3vh', rotate: -3, scale: 0.82, opacity: 1 },
    { x: '9vw', y: '2vh', rotate: 2, scale: 0.58, opacity: 0.88 },
    { x: '12vw', y: '3vh', rotate: -1, scale: 0.32, opacity: 0.58 },
    { x: '12.8vw', y: '4vh', rotate: 0, scale: 0.24, opacity: 0.32 },
    { x: '13vw', y: '5vh', rotate: 0, scale: 0.05, opacity: 0 },
  ],
  threads: [
    { x: '-2vw', y: '-5vh', rotate: 4, scale: 0.95, opacity: 1 },
    { x: '-7vw', y: '-7vh', rotate: -3, scale: 0.86, opacity: 1 },
  ...
  bookmarks: [
    { x: '4vw', y: '-5vh', rotate: -4, scale: 0.96, opacity: 1 },
    { x: '10vw', y: '-7vh', rotate: 3, scale: 0.87, opacity: 1 },
    { x: '15vw', y: '-8vh', rotate: -3, scale: 0.66, opacity: 0.92 },
    { x: '19vw', y: '-7vh', rotate: 2, scale: 0.38, opacity: 0.64 },
    { x: '20.5vw', y: '-5vh', rotate: 0, scale: 0.3, opacity: 0.42 },
    { x: '21vw', y: '-2vh', rotate: 0, scale: 0.06, opacity: 0 },
  ],
  photos: [
    { x: '-4vw', y: '4vh', rotate: 4, scale: 0.96, opacity: 1 },
    { x: '-9vw', y: '3vh', rotate: -3, scale: 0.87, opacity: 1 },
    { x: '-14vw', y: '2vh', rotate: 3, scale: 0.66, opacity: 0.92 },
    { x: '-18vw', y: '3vh', rotate: -2, scale: 0.37, opacity: 0.67 },
    { x: '-19.5vw', y: '4vh', rotate: 0, scale: 0.28, opacity: 0.44 },
    { x: '-20vw', y: '5vh', rotate: 0, scale: 0.06, opacity: 0 },
  ],
  'voice-memos': [
    { x: '3vw', y: '6vh', rotate: 3, scale: 0.92, opacity: 1 },
    { x: '6vw', y: '5vh', rotate: -3, scale: 0.8, opacity: 1 },
    { x: '10vw', y: '4vh', rotate: 2, scale: 0.56, opacity: 0.86 },
    { x: '13vw', y: '5vh', rotate: -1, scale: 0.3, opacity: 0.56 },
    { x: '13.8vw', y: '6vh', rotate: 0, scale: 0.22, opacity: 0.3 },
    { x: '14vw', y: '7vh', rotate: 0, scale: 0.05, opacity: 0 },
  ],
  receipts: [
    { x: '-3vw', y: '6vh', rotate: -4, scale: 0.94, opacity: 1 },
    { x: '-8vw', y: '5vh', rotate: 3, scale: 0.84, opacity: 1 },
    { x: '-13vw', y: '4vh', rotate: -2, scale: 0.62, opacity: 0.9 },
    { x: '-17vw', y: '5vh', rotate: 1, scale: 0.35, opacity: 0.6 },
    { x: '-18.5vw', y: '6vh', rotate: 0, scale: 0.26, opacity: 0.36 },
    { x: '-19vw', y: '7vh', rotate: 0, scale: 0.05, opacity: 0 },
  ],
  'voice-memos': [
