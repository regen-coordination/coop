  ...
  return (
    <section className="popup-screen popup-screen--fill">
      <div className="popup-copy-block">
        ...
        <h1>{coop ? `${coop.coopName} is ready.` : 'Your coop is ready.'}</h1>
        <p className="popup-footnote">
          Share these codes to invite people in. Member codes are for participants, trusted codes
          grant stewardship access.
        </p>
      </div>

      {coop ? (
        <div className="popup-invite-lanes">
          <PopupInviteTypeCard
