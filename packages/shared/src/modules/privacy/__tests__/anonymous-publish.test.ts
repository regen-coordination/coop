...
// The mock generates deterministic proof-shaped objects and verifies them by checking
// a marker field, so test assertions (valid proof, distinct nullifiers, correct message)
// remain meaningful without real cryptography.
  ...
  return {
    ...
    generateProof: vi.fn(
      async (
        ...
        // Produce a deterministic hash-like string from an input value
    ...
    verifyProof: vi.fn(async (proof: Record<string, unknown>) => {
      // Only verify proofs generated by our mock
